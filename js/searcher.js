...
/** scope of the search */
var scope = "10906/5698";
var search_scope="10906/5698";
var search_scope_name="Archivo del Patrimonio Fotográfico y Fílmico del Valle del Cauca";
...
jQuery(document).ready(function(){
    ...
    jQuery("#scope_community option, #10906_5699 option, #10906_5776 option, #10906_65426 option").each(function(){
    ...
    jQuery("#scope_community").change(function(){
        jQuery("#10906_5699, #10906_5776, #10906_65426").hide();
    ...
    jQuery("#10906_5699, #10906_5776, #10906_65426").change(function(){
...
function validate(){
    ...
    if(query==null || query=="" || query=="Digita el tema a buscar..."){               
        ...
        if(scope=="10906/5776" || scope=="10906/5699" || scope=="10906/5698" || data_level==0 || data_level==1){
